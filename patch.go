...
func applyPatch(test bool, originalFileName, finalFileName, forceOS string) error { // deprecated average runtime 5.5s | byte version avg runtime 0.4s
...
func applyPatchByte(test bool, originalFileName, finalFileName, forceOS string) error {
